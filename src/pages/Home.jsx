...
import { ArrowRight, ShieldCheck, Zap, Headphones, ChevronRight, Banknote, FileText, TrendingUp, Shield, BarChart3, Upload, UserCheck, Clock, CheckCircle, Globe } from 'lucide-react';
         ...
         <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
              {[
                ...
                { title: "CIBIL Repair Services", icon: Globe, desc: "Improve your credit score with expert guidance across India, USA, and Canada." },
              ].map((service, idx) => (
                <motion.div
                  key={idx}
